...
Tapestry promises that data contributes without leaving and that sovereignty is enforceable through the appropriate mix of technical, legal, and organizational mechanisms ([Design Goal 2](../../architecture/4-design-goals.md)). This work group is grounded in [Design Goal 2](../../architecture/4-design-goals.md), [Design Goal 6](../../architecture/4-design-goals.md), and the privacy/security implications of the consortium training loop in [TAP-004](../../architecture/decisions/adr-004-training-loop.md).
...
- Leakage analysis for per-step gradients, contributed model weights, adapters, routing, logs, and evaluation artifacts.
...
- When are contributed model weights sufficient, and when are DP, secure aggregation, or TEEs required?
