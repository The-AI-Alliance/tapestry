...
| [`build4me2-contribution-validator`](build4me2-contribution-validator/README.md) | [@build4me2](https://github.com/build4me2) | Candidate | Admission-safety validator that checks a consortium contribution for parameter coverage, shape/dtype compatibility, finite values, and update magnitude before the outer merge |
