...
The [AI Alliance](https://www.thealliance.ai){:target="aia"} created and develops [Project Tapestry]({{site.tapestry_url}}){:target="aia-tapestry"}.
...
* [More About the AI Alliance](https://www.thealliance.ai/){:target="aia"}
