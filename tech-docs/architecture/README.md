...
| :------- | :---------- |
| [`0-tva-methodology.md`](0-tva-methodology.md) | The TVA design process — six phases, current status |
...
| [`diagrams/`](diagrams/README.md) | SVG figures for docs (optional PNG); see [`diagrams/README.md`](diagrams/README.md) |
