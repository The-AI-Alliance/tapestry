...
```shell
git clone https://github.com/The-AI-Alliance/tapestry.git
cd tapestry
```
...
Your website should be published after a few minutes to `https://the-ai-alliance.github.io/tapestry/``.
